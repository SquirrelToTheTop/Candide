...
QT_MOC_LITERAL(6, 81, 21)
    ...
    "MainFrame\0newApplication\0\0delApplication\0"
    "loadApplicationData\0saveApplicationData\0"
    "getNewCandidatureData\0"
};
...
void MainFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newApplication(); break;
        case 1: _t->delApplication(); break;
        case 2: _t->loadApplicationData(); break;
        case 3: _t->saveApplicationData(); break;
        case 4: _t->getNewCandidatureData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
